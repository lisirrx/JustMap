...
public class TitledButtonWidget<W extends ClickableWidget> extends ClickableWidget implements Element {
	...
	@Override
	public void render(DrawContext drawContext, int int_1, int int_2, float float_1) {
		drawContext.drawTextWithShadow( font, title.string(), getX(), getY(), 0xFFFFFFFF);
		widget.render(drawContext, int_1, int_2, float_1);
	}
	...
	@Override
	public void renderButton(DrawContext drawContext, int int_1, int int_2, float float_1) {
		this.widget.renderButton(drawContext, int_1, int_2, float_1);
	}
