...
public class RegionData implements MapRegion {
	...
	public void draw(DrawContext drawContext, double x, double y, double width, double height, int imgX, int imgY, int imgW, int imgH) {
		...
		this.drawTexture(drawContext, x, y, width, height, u1, v1, u2, v2);
	}

	@Override
	public void drawLayer(DrawContext drawContext, Layer layer, int level, double x, double y, double width, double height, int imgX, int imgY, int imgW, int imgH) {
		swapLayer(layer, level);
		draw(drawContext, x, y, width, height, imgX, imgY, imgW, imgH);
	}

	private void drawTexture(DrawContext drawContext, double x, double y, double w, double h, float u1, float v1, float u2, float v2) {
		...
		RenderUtil.addQuad(drawContext, x, y, w, h, u1, v1, u2, v2);
		RenderUtil.endDraw();
	}
