...
public class WaypointIcon extends MapIcon<WaypointIcon> {
	...
	public void draw(DrawContext drawContext, int size) {
		...
		if (icon != null) {
			icon.draw(drawContext, x, y, size);
		}
	}

	public void draw(DrawContext drawContext, VertexConsumerProvider consumerProvider, int mapX, int mapY, int mapW, int mapH, double offX, double offY, double rotation) {
		...
		this.draw(drawContext, consumerProvider, mapX, mapY, mapW, mapH, (float) rotation);
	}
	...
	public void draw(DrawContext drawContext, VertexConsumerProvider consumerProvider, int mapX, int mapY, int mapW, int mapH, float rotation) {
		...
		if (icon != null) {
			...
			icon.draw(drawContext, iconPos.x - offX, iconPos.y - offY, iconSize);
			RenderUtil.texEnvMode(GLC.GL_MODULATE);
